...
//firebase methods
import { fetchCustomers, fetchProducts, fetchSalesInvoice,DeleteSalesInvoice }  from '../../../../Services/FirebaseSerice';
...
const SalesInvoice= () => {
  ...
  const deleteSelected = () => {
    if(window.confirm("Are you sure you want to delete?")){
      ...
      DeleteSalesInvoice(selectedArray)
      .then(() => {
        setLoading(false);
    ...
    <Fragment>
      <Card>
        <CardHeader className="">
          <CardTitle tag='h4'>Sale Invoice Bill</CardTitle>
        ...
        {showSearch && <CardText className="ml-3 mr-3">
          ...
          <Form>
              <Row>
                  ...
                  <Col xs={12} sm={6} md={3} >
                      <Form.Group controlId="invoiceQuery">
                  ...
                  <Col xs={12} sm={6} md={3} >
                      <Form.Group controlId="totalQuery">
